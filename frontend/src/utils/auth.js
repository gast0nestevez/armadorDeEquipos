...
export const handleGoogleLogin = async (credentialResponse, setUser) => {
  ...
  const url = `${API_BASE_URL}/auth/googleLogin`
  const options = {
    method: 'POST',
...
export const handleEmailLogin = async (email, password, setUser) => {
...
export const handleEmailRegister = async (email, password, setUser) => {
